    ...
    return (
        <> 
            <div className='pet-listing-card-wrapper'>
                ...
                <div style={{width: "30%", height: "inherit", backgroundColor: "#bebeff", color: "black", boxSizing: "border-box", borderRadius: '0px 6px 6px 0px'}}>
                    <img style={{objectFit: 'cover', width: '100%', height: '100%'}} src={data.imgSource} alt={data.petName}></img>
                </div>
            </div>
        </>
    )
