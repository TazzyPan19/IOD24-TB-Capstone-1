...
export const PetListing = () => {
    ...
    const petBreeds = [
        ...
        {id: 20, page: 'Page 2', name: "Maximilian’s Pionus"},
        {id: 21, page: 'Page 3', name: "American Sable"},
        {id: 22, page: 'Page 3', name: "Angora Rabbit"},
        {id: 23, page: 'Page 3', name: "Belgian Hare"},
        {id: 24, page: 'Page 3', name: "Dutch Rabbit"},
        {id: 25, page: 'Page 3', name: "Blanc De Hotot"},
        {id: 26, page: 'Page 3', name: "Netherland Dwarf Rabbit"},
        {id: 27, page: 'Page 3', name: "American"},
        {id: 28, page: 'Page 3', name: "White Crested"},
        {id: 29, page: 'Page 3', name: "Rex"},
        {id: 30, page: 'Page 3', name: "Silkie / Sheltie"},
        {id: 31, page: 'Page 4', name: "Peruvian"},
        {id: 32, page: 'Page 4', name: "Coronet"},
        {id: 33, page: 'Page 4', name: "American Staffordshire Terrier"},
        {id: 34, page: 'Page 4', name: "Australian Terrier"},
        {id: 35, page: 'Page 4', name: "Border Collie"},
        {id: 36, page: 'Page 4', name: "Cocker Spaniel"},
        {id: 37, page: 'Page 4', name: "Dachshund Kaninchen Smooth Haired"},
        {id: 38, page: 'Page 4', name: "Harrier"},
    ]
