            ...
            <>
                <div className='app-content-wrapper-viewer'>
                    <section style={{display: 'flex', }}>
                        <div style={{width: '80%'}}>
                            <img src={catDefaultImg} alt="default-picture" width={'100%'} height={'470px'} />
                        </div>
                        <div className="outfit-regular" style={{width: '50%', height: '580px',  backgroundColor: '#b4aaf7', padding: '20px'}}>
                            ...
                            <div style={{display: 'flex', flexDirection: 'column', height: '510px', justifyContent: 'space-between', width: '300px'}}>
                                ...
                                <div>
                                    <Link to={'/adoption-form'} style={{padding: '7px 1.5px 7px 2px', border: '2px solid #13131c', borderRadius: '4px'}}>
...
// "petName": "Rood Girl",
// "descriptionText": "",
// "catergory": "Dog Breeds",
// "typeName": "Australian Kelpie",
// "sex": "female",
// "age": 8,
// "weight": "18kg",
// "desexed": true,
// "vaccinated": false,
// "dewormed": false,
// "colour": "black and white fur",
// "userId": 3,
// "createdAt": "2024-09-10T19:50:39.000Z",
// "updatedAt": "2024-09-10T19:50:39.000Z"
